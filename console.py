...
def split_curly_braces(e_arg):
    """
    this Splits curly braces for update method
    """
    ...
    if curly_braces:
        ...
        try:
            ...
            print("** is invalid dictionary format **")
            return
        return id, arg_dict
    else:
...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """
        it does nothing when empty line is entered.
        """
        pass

    def do_EOF(self, arg):
        """
        EOF (Ctrl+D) signal to exit program.
        """
        return True
    ...
    def do_create(self, arg):
        """
        it Creates new instance of BaseModel and save it to JSON file.
    ...
    def do_show(self, arg):
        """
        Showes string representation of instance.
    ...
    def do_all(self, arg):
        """
        Prints string representation of all instances or specific class.
        Usage: <User>.all()
                <User>.show()
        """
        objects = storage.all()
    ...
    def do_count(self, arg):
        """
        this counts and retrieves the number of instances of class
