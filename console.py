...
"""
the module consule.py a cmd console
"""
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_EOF(self, arg):
        '''Quit command CTRL+D to exit program'''
        print("")
        return True
    ...
    def do_create(self, args):
        ''' Creates new instance BaseModel, saves prints its id '''
        if args == "":
    ...
    def do_show(self, args):
        ''' Prints string repr of instances class name and id '''
        arg = shlex.split(args)
        if len(arg) == 0:
            print("** class name missing **")
            return
    ...
    def do_destroy(self, args):
        ''' Deletes instance based on class name and id (save changes
            into JSON file) '''
    ...
    def do_update(self, args):
        ''' Updates instance based on class name & id adding/updating
    ...
    def do_count(self, args):
        ''' it counts number of instnces created '''
        obj = storage.all()
        cnt = 0
        for key in obj:
            if (args in key):
