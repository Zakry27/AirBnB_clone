#!/usr/bin/python3
"""
the Unittest Module for FileStorage
"""
import unittest
...
class TestFileStorage(unittest.TestCase):
    ''' the Unittest for FileStorage class '''

    def test_Instantiation(self):
        ''' this checks instance is of class BaseModel '''
        obj = FileStorage()
        self.assertIsInstance(obj, FileStorage)

    def test_Access(self):
        ''' this test read-write access permissions '''
    ...
    def test_new(self):
        """
        the Tests method: new (saves new object into dictionary)
        """
    ...
    def test_reload(self):
        """
        the Tests method: reload (reloads objects from string file)
        """
    ...
    def test_funcdocs(self):
        ''' the testing functions docstring '''
        for func in dir(FileStorage):
            self.assertTrue(len(func.__doc__) > 0)

    def test_save(self):
        ''' the tests save method'''
        obj = FileStorage()
        new_obj = BaseModel()
        obj.new(new_obj)
        dict1 = obj.all()
