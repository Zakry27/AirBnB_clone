...
class TestCity_instantiation(unittest.TestCase):
    """
    the Unittests for instantiation of City class.
    """
...
class TestCity_save(unittest.TestCase):
    """this is the unittests to test save method of City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """the Unittests for testing to_dict method of City class."""
